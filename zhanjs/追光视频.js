var rule = {
    ...
    类型: '影视',
    //主页 网页的域名根
    //https://www.4kmovie.site/
    //https://zg01.inavs.cn/
    host: 'https://zg01.inavs.cn/',
    hostJs: ``,
    headers: {
    ...
    //分类链接,分类参数用fyclasss,页码用fypage，带筛选的用fyfilter，第一页无页码的用[]括起，处理方式同xbpq方式，fyfilter代表filter_url里内容
     ...
     //   https://zg01.inavs.cn/k/6-大陆-------2---2021/
    url: 'https://zg01.inavs.cn/k/fyfilter/',
    filter_url: '{{fl.cateId}}-{{fl.area}}-------fypage---{{fl.year}}',
    detailUrl: 'https://zg01.inavs.cn/vodplay/fyid/',
